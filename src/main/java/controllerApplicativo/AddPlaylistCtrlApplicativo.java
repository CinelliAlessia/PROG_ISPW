...
public class AddPlaylistCtrlApplicativo {
    ...
    public static ArrayList<PlaylistBean> retriveList() throws SQLException {
        ...
        for (Playlist p : playlists){
            PlaylistBean pB = new PlaylistBean(p.getEmail(),p.getUsername(),p.getPlaylistName(),p.getLink(),p.getPlaylist_genre());
