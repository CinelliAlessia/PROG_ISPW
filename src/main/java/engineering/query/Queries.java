...
public class Queries {
    ...
    public static final String UPDATE_GENERI_MUSICALI_QUERY =
            "UPDATE generi_musicali " +
    ...
    public static final String SELECT_GENRED_USER_QUERY = "SELECT * FROM generi_musicali WHERE id = 0"; //'%d'
}
